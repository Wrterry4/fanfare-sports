...
export const ROLE_CAPABILITIES = {
  ...
  [ROLES.SCOREKEEPER]: { score: true,  manageRoster: false, approveTransfers: false, teamChat: true,  seeAllPlayers: false },
  [ROLES.PARENT]:      { score: false, manageRoster: false, approveTransfers: true,  teamChat: true,  seeAllPlayers: false },
...
export const INVITE_TYPES = {
  ...
  TEAM: 'team',      // general: assistant coach, team parent, scorekeeper
};
 ...
 */
const PRECEDENCE = [ROLES.FAN, ROLES.PARENT, ROLES.SCOREKEEPER, ROLES.COACH, ROLES.OWNER];
